...
ActiveRecord::Schema[7.1].define(version: 2024_07_23_002938) do
  ...
  create_table "pools", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "first_place_winner_id"
    t.integer "second_place_winner_id"
    t.integer "third_place_winner_id"
